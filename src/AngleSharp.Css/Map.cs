namespace AngleSharp.Css
{
    ...
    static class Map
    {
        ...
        {
            { CssKeywords.XxSmall, FontSize.Tiny },
            { CssKeywords.XSmall, FontSize.Little },
            { CssKeywords.Small, FontSize.Small },
            { CssKeywords.Medium, FontSize.Medium },
            { CssKeywords.Large, FontSize.Large },
            { CssKeywords.XLarge, FontSize.Big },
            { CssKeywords.XxLarge, FontSize.Huge },
            { CssKeywords.Larger, FontSize.Smaller },
            { CssKeywords.Smaller, FontSize.Larger },
        };
